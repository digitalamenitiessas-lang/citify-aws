...
const ITEMS: Array<{
...
}> = [
  {
    key: 'complaints',
    label: 'Expedientes',
    description: 'Nuevos mensajes, cambios de estado y menciones en expedientes de tu edificio.',
  },
  {
    key: 'liquidations',
    label: 'Liquidaciones',
    description: 'Cuando se emite o cierra una liquidación de expensas en tu edificio.',
  },
  {
    key: 'announcements',
    label: 'Comunicados',
    description: 'Anuncios del consorcio dirigidos a vecinos.',
  },
  {
    key: 'promotions',
    label: 'Promociones',
    description: 'Nuevas promociones de comercios cercanos. Desactivado por defecto.',
  },
]
