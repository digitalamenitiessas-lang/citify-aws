...
interface Props {
  // Si true, pedimos contraseña actual (cambio in-session de un usuario que
  // ya tiene una pwd definitiva). Si false, es el flujo de primer login
  // forzado: solo pedimos la nueva.
  requireCurrent: boolean
  // A donde redirigir cuando se completa con exito. Si no se pasa, se queda
  // en la misma pagina mostrando "exito".
