...
export function LoginForm() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    // Si arranca con contrasena temporal, lo redirigimos al cambio forzado
    // antes de mostrarle el panel propio del rol.
  ...
  return (
    <>
      ...
      {/* Modal a nivel sibling del form para que su submit no caiga al login. */}
      {forgotOpen ? (
        <div
