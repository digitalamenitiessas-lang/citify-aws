  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="font-bold text-foreground text-lg">Comunicados del edificio</h2>
      </div>
      ...
      {announcements.length === 0 ? (
        <div className="glass-card rounded-2xl px-5 py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Todavía no hay comunicados de tu edificio. Cuando la administración publique algo, lo
            vas a ver acá.
          </p>
        </div>
      ) : (
