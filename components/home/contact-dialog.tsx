...
export type ContactKind = 'building' | 'business'
...
const COPY: Record<ContactKind, {
  ...
  building: {
    title: 'Sumá tu edificio a Citify',
    description: 'Contanos sobre tu consorcio y te respondemos a la brevedad.',
    orgLabel: 'Nombre del edificio o consorcio',
    orgPlaceholder: 'Ej: Edificio Belgrano, CABA',
    messagePlaceholder: 'Contanos cantidad de unidades, ubicación, y cualquier detalle que sirva.',
  },
  business: {
    title: 'Adherí tu negocio a Citify',
    description: 'Llegá a residentes de edificios y consorcios.',
      ...
      <DialogContent className="sm:max-w-md">
        ...
        {success ? (
          <div className="space-y-4 py-4 text-center">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[var(--citify-terracotta)]/10 text-[var(--citify-terracotta)]">
              <CheckCircle2 className="h-7 w-7" />
            </div>
            <div>
              <p className="font-semibold text-foreground">¡Mensaje enviado!</p>
              <p className="mt-1 text-sm text-muted-foreground">Te contactamos a la brevedad.</p>
            </div>
