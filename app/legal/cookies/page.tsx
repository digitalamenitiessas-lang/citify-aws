export const metadata = {
  title: 'Política de Cookies — Citify',
}
...
export default function CookiesPage() {
  return (
    <>
      ...
      <h2>2. Qué cookies usamos en Citify</h2>
      <p>
        Citify usa <strong>únicamente cookies estrictamente necesarias</strong> para
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td><code>citify_session</code></td>
      ...
      <p>
        Citify <strong>no usa</strong> servicios de analítica de terceros (Google
        Analytics, Hotjar, etc.) ni redes publicitarias. Si en el futuro lo
        hacemos, te avisaremos y te pediremos consentimiento explícito.
      </p>
      ...
      <p>
        ...
        podrás iniciar sesión en Citify.
      </p>
      <ul>
        <li>
          <a
