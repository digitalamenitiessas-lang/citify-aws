export const metadata = {
  title: 'Política de Privacidad — Citify',
}
  ...
  return (
    <>
      ...
      <p>
        ...
        los datos personales de los usuarios de Citify (“la Plataforma”), en
      ...
      <ul>
        <li>
          ...
          rol (vecino, propietario, administrador del consorcio, etc.).
        </li>
        <li>
          <strong>Datos del consorcio:</strong> edificio, unidad, vínculo
          (propietario / inquilino principal / conviviente).
        </li>
        <li>
          <strong>Datos operativos:</strong> liquidaciones de expensas, pagos
          registrados, expedientes y mensajes asociados, gastos, movimientos
          bancarios. Cargados por el administrador del consorcio.
        </li>
        <li>
      ...
      <ul>
        <li>Prestar el servicio (mostrar liquidaciones, registrar pagos, etc.).</li>
        <li>
      ...
      <h2>3. Base legal</h2>
      <p>
        El tratamiento se basa en (a) el consentimiento del usuario al registrarse
        o ser dado de alta por su administrador, (b) la necesidad de ejecutar
        el contrato de prestación de servicios, y (c) el cumplimiento de
      ...
      <ul>
        ...
        <li>
          <strong>Administración del consorcio:</strong> los administradores ven
          los datos de los vecinos del edificio que administran.
        </li>
        <li>
      ...
      <h2>5. Retención</h2>
      <p>
        Conservamos los datos mientras tenés cuenta activa o mientras tu
        consorcio mantiene contrato con Citify. Los datos financieros se
        retienen al menos por el plazo que exige la normativa fiscal (10 años).
        Después podés solicitar su eliminación.
      </p>
      ...
      <p>
        Citify no está destinada a menores de 16 años. Si detectamos datos de
        menores sin autorización del responsable legal, los eliminamos.
      </p>
