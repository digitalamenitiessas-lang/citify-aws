...
// PDF descargable de la liquidacion pública (la misma que muestra el
...
export async function GET(
  ...
  // renderToBuffer devuelve un Buffer (Node). NextResponse acepta
  // BodyInit, asi que lo pasamos como Uint8Array.
